...
<nav class="navbar navbar-default navbar-fixed-top" role="navigation">
    <div class="container">
        ...
        <div class="navbar-header">
            ...
            <a class="navbar-brand" href="{{ route('clients.home') }}"><span>littleHotel</span></a>
        </div>
        <div class="navbar-collapse collapse">
            <div class="menu">
                <ul class="nav nav-tabs" role="tablist">
                    <li role="presentation" class="active"><a href="{{ route('clients.home') }}">Home</a></li>
                    <li role="presentation"><a href="{{ route('clients.room') }}">Booking</a></li>
                    @if (Route::has('login'))
                        @auth
...
<footer>
    ...
    <div class="last-div">
        <div class="container">
            <div class="row">
                <div class="copyright">
                    &copy; Hotel Reservation. All Rights Reserved
                    <div class="credits">
                        <!--
                        ...
                        -->
                        Designed by <a href="#">Kyaw zin Htet</a>
                    </div>
                </div>
            </div>
        </div>
